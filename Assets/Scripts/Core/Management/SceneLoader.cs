...
using Core.Management.Transition;
...
namespace Scene
{
  public class SceneLoader
  {
    ...
    public SceneLoader Load()
    {
      ...
      coroutine = Manager.StartCoroutine(LoadRoutine());
      return this;
    }
    ...
    private IEnumerator LoadRoutine()
    {
      ...
      if (isPause) Utility.Pause(isSmooth, outTransition.speed * 0.9f);
      TransitionMgr.Play(outTransition.type, outTransition.speed);
      ...
      if (isPause) Utility.UnPause(isSmooth, inTransition.speed * 0.9f);
      TransitionMgr.Play(inTransition.type, inTransition.speed);
